                ...
                <div class="row">
                    <div class="contianer staff">
                        ...
                        " placeholder="Shedule ID. Don't fill when creating new shedule"> <br></br>
                                ...
                                <select name="theater_id" class="sec-role" placeholder="Select Theater ID" value="">
                                    <option value="<?php if (isset($_SESSION['t_id'])) {
                                        echo $_SESSION['t_id'];
                                    } else {
                                        echo '';
                                    } ?>">
                                        <?php if (isset($_SESSION['t_id'])) {
                                            ...
                                            $_SESSION['t_id'] = 'Select Theater ID';
                                            echo $_SESSION['t_id'];
                                            unset($_SESSION['t_id']);
                                        } ?></option>

                                    <?php
                                    $sql = "SELECT t_id FROM theater";
                                ...
                                <select name="shift" class="sec-role" placeholder="Select shift" value="">
                                    <option value="<?php if (isset($_SESSION['staff_shift'])) {
                                        ...
                                        echo '';
                                    } ?>"><?php if (isset($_SESSION['staff_shift'])) {
                                         echo $_SESSION['staff_shift'];
                        ...
                        if (isset($_POST['addshedule'])) {
                            $id = $_POST['id'];
                            $t_id = $_POST['theater_id'];
                            $shift = $_POST['shift'];
                            $s_date = $_POST['s_date'];
                            $staff = $_POST['staff'];


                            $sql = "INSERT INTO theater_shedule(t_id,s_id,sheduled_date,sheduled_shift) VALUES({$t_id},{$staff},'{$s_date}','{$shift}');";
                            ...
                            if ($conn->query($sql) === true) {
                                ...
                                echo "<script>
                                alert('Theater sheduled for the staff member');
                                ...
                                echo "<script>
                                alert('Cannot shedule this theater for this staff member.');
                                location.replace('theater.php');
                            </script>";
                            }
                        }
                        ...
                        if (isset($_POST['updateshedule'])) {
                            ...
                            $s_date = $_POST['s_date'];
                            $staff = $_POST['staff'];
                            $sql = "UPDATE theater_shedule SET t_id = {$t_id} , s_id = {$staff}, sheduled_date = '{$s_date}', sheduled_shift='{$shift}' WHERE ta_id = {$id}";
                        ...
                        <div class="show-row">
                            <div class="container staff-section" id="all-rooms">
                                <h1 class="form-topic">All Theater Shedules</h1>
                                <table class="staff-table">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            $sql = "SELECT * FROM theater_shedule r, staff s WHERE r.s_id = s.s_id";
                                            ...
                                            <td><a class='showbtn' href='helper.php?tshowid={$row['ta_id']}' ><i class='fa-regular fa-eye'></i></a>
                                            <a class='deletebtn' href='helper.php?tdelid={$row['ta_id']}' onclick='delconfirmation()'><i class='fa-solid fa-trash'></i></a>
                                            </td>
                                            </tr>";
                                                }
                                            } else {
